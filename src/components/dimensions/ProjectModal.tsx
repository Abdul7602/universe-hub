    ...
    <>
      <style>
        {`
          ...
          .pjm-corner.tl { top: 0; left: 0; border-width: 1px 0 0 1px; }
          .pjm-corner.tr { top: 0; right: 0; border-width: 1px 1px 0 0; }
          .pjm-corner.bl { bottom: 0; left: 0; border-width: 0 0 1px 1px; }
          .pjm-corner.br { bottom: 0; right: 0; border-width: 0 1px 1px 0; }
